...
import edu.ulima.sw2.Login_Service;
...
public class Servlet03 extends HttpServlet {
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/SubastaWS/Login.wsdl")
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(rpta==true){
            ...
            rs=request.getRequestDispatcher("/"+tipo+".jsp");
            rs.forward(request, response);
        }
    ...
    private boolean login(java.lang.String usuario, java.lang.String clave) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        edu.ulima.sw2.Login port = service.getLoginPort();
